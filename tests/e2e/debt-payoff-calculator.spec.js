...
const SVC_URL = "https://appadaycreator.com/debt-payoff-calculator/";
const SVC_NAME = "借金・ローン返済シミュレーター";

test.describe("借金・ローン返済シミュレーター - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("debt-payoff-calculator");
